...
def get_links(tv_movie,original_title,season_n,episode_n,season,episode,show_original_year,id):
    ...
    if tv_movie=='movie':
     ur='https://thepiratebay-plus.strem.fun/stream/movie/%s.json'%imdb_id
    elif tv_movie=='tv':
     ur='https://thepiratebay-plus.strem.fun/stream/movie/{0}%3A{1}%3A{2}.json'.format(imdb_id,season,episode)
