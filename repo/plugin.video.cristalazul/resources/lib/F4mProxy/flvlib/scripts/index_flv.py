...
from resources.lib.F4mProxy.flvlib import __versionstr__
from resources.lib.F4mProxy.flvlib.astypes import MalformedFLV, FLVObject
from resources.lib.F4mProxy.flvlib.constants import FRAME_TYPE_KEYFRAME
from resources.lib.F4mProxy.flvlib.constants import TAG_TYPE_AUDIO, TAG_TYPE_VIDEO, TAG_TYPE_SCRIPT
from resources.lib.F4mProxy.flvlib.helpers import force_remove
from resources.lib.F4mProxy.flvlib.tags import FLV, EndOfFile, AudioTag, VideoTag, ScriptTag
from resources.lib.F4mProxy.flvlib.tags import create_script_tag, create_flv_header
...
def retimestamp_and_index_file(inpath, outpath=None, retimestamp=None):
    ...
    # retimestamp the input in place and index
        ...
        from resources.lib.F4mProxy.flvlib.scripts.retimestamp_flv import retimestamp_file_inplace
    ...
    # retimestamp the input into a temporary file
        ...
        from resources.lib.F4mProxy.flvlib.scripts.retimestamp_flv import retimestamp_file_atomically
...
def index_file(inpath, outpath=None):
    ...
    if not outpath:
        ...
        try:
            ...
            log.error("Failed to overwrite the original file with the indexed version: %s", strerror)
            return False
