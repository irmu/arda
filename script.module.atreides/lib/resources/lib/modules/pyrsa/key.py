...
from resources.lib.modules.pyrsa._compat import range
from resources.lib.modules.pyrsa import prime as rsa_prime
from resources.lib.modules.pyrsa import pem as rsa_pem
from resources.lib.modules.pyrsa import common as rsa_common
from resources.lib.modules.pyrsa import randnum as rsa_randnum
from resources.lib.modules.pyrsa import core as rsa_core
...
class PublicKey(AbstractKey):
    ...
    def _load_pkcs1_der(cls, keyfile):
        ...
        from resources.lib.modules.pyasn1.codec.der import decoder
    ...
    def _save_pkcs1_der(self):
        ...
        from resources.lib.modules.pyasn1.codec.der import encoder
        from .asn1 import AsnPubKey
    ...
    def load_pkcs1_openssl_der(cls, keyfile):
        ...
        from resources.lib.modules.pyasn1.codec.der import decoder
        from resources.lib.modules.pyasn1.type import univ
...
class PrivateKey(AbstractKey):
    ...
    def _save_pkcs1_der(self):
        ...
        from resources.lib.modules.pyasn1.type import univ, namedtype
        from resources.lib.modules.pyasn1.codec.der import encoder
...
def find_p_q(nbits, getprime_func=rsa_prime.getprime, accurate=True):
...
def gen_keys(nbits, getprime_func, accurate=True, exponent=DEFAULT_EXPONENT):
    ...
    :param getprime_func: either :py:func:`rsa_prime.getprime` or a function
...
def newkeys(nbits, accurate=True, poolsize=1, exponent=DEFAULT_EXPONENT):
    ...
    if poolsize > 1:
        from resources.lib.modules.pyrsa import parallel
        import functools
