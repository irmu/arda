...
"""
    ...
    Changelog:
        2019-07-29
            - Replaced instance of "arrakis" with "jen" in disable_this function
        ...
        2018-05-21
            ...
            - Takes into account if end-user API keys are stored in settings, and doesn't update it if they are
    ...
    Usage:
        Set this in your Jen v1.6 or higher and it should keep your end user's API Keys and Root XML in order automatically.
        Takes into account when users have entered their own API keys.
...
def disable_this():
    ...
    if re.search('xbmc.service', xml_content):
        xml_content = xml_content.replace('xbmc.service', 'xbmc.jen')
