...
def cache_version_check():
    ...
    if _find_cache_version():
        ...
        control.infoDialog(control.lang(32262).encode('utf-8'), sound=True, icon='INFO')
...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'ExtendedInfo Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/script.extendedinfo')
    ...
    try:
        curVersion = control.addon('script.extendedinfo').getAddonInfo('version')
